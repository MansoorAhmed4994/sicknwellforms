...
class InOfficeAppointsController extends Controller
{
    /**
    ...
    public function update(Request $request, $id)
    {
        ...
        if(Auth::guard('clients')->check())
        {
            return redirect()->route('client.InOfficeAppoints.submissions',$in_office_appointments->client_forms_id);
        }
        else
        {
            return redirect()->route('InOfficeAppoints.submissions',$in_office_appointments->client_forms_id);
        }
        //session()->flash("success","Successfully Updated");  
        //return view('forms.status');
    }
