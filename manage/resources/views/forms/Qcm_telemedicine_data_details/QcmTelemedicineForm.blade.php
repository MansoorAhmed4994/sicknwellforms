...
<body>
    ...
    <div class="qcm-form" >
        ...
        <div>
    <form method="post" action="{{route('QcmTelemedicineForm.create')}}" class="position-relative">
            {{csrf_field()}}
            ...
            <input type="hidden" value="qcm_telemedicine_data_details" id="table_name" name="table_name">
                ...
                @endif
                        ...
                        <div class="form-group row mt-4">
                                    ...
                                    <div class="col-12 col-md-4">
                                        <div class="padding-wrap">
                                            <input type="text" class="form-control custom-mainforminput @if($errors->get('patient_first_name')) is-invalid @endif"
                                                name="patient_first_name" id="patient_first_name" value="{{old('patient_first_name')}}"/>
                                    ...
                                    <div class="col-12 col-md-4">
                                        <div class="padding-wrap">
                                            <input type="text" class="form-control custom-mainforminput @if($errors->get('patient_middle_name')) is-invalid @endif"
                                                name="patient_middle_name" id="patient_middle_name" value="{{old('patient_middle_name')}}"/>
                                    ...
                                    <div class="col-12 col-md-4">
                                        <div class="padding-wrap">
                                            <input type="text" class="form-control custom-mainforminput @if($errors->get('patient_last_name')) is-invalid @endif"
                                                name="patient_last_name" id="patient_last_name" value="{{old('patient_last_name')}}"/>
                            ...
                            <div class="col-12 col-md-2">
                                ...
                                <input type="tel" class="form-control custom-mainforminput @if($errors->get('telephone')) is-invalid @endif" name="telephone"
                                    id="telephone" value="{{old('telephone')}}"  data-inputmask='"mask": "(999) 999-9999"' data-mask />
                            </div>
                            <div class="col-12 col-md-2">
                            ...
                            <div class="col-12 col-md-2">
                                ...
                                <input type="text" class="form-control custom-mainforminput @if($errors->get('employer_occupation')) is-invalid @endif" value="{{old('employer_occupation')}}" name="employer_occupation" id="employer_occupation" />
                            </div>
                        </div>
                        <div class="row form-group">
                                ...
                                <div class="row no-gutters">
                                    ...
                                    <div class="col-12 col-md-4">
                                        <div class="padding-wrap">
                                            ...
                                            <input type="text"  value="{{old('dob')}}" class="form-control custom-mainforminput dobpicker  @if($errors->get('dob')) is-invalid @endif"
                            ...
                            <div class="col-12 col-md-3 showIfMinor d-none" id="IsMinordviid">
                                ...
                                <input type="text" class="form-control custom-mainforminput  @if($errors->get('parent_guardian')) is-invalid @endif" value="{{old('parent_guardian') ? old('parent_guardian') : '' }}" name="parent_guardian"
                                    id="parent_guardian" />
                            </div>
                            <div class="col-12 col-md-3 showIfMinor d-none" >
                                <label>Relation to Patient <span class="required">*</span></label>
                                <input type="text" class="form-control custom-mainforminput  @if($errors->get('relation_to_patient')) is-invalid @endif"  value="{{old('relation_to_patient') ? old('relation_to_patient') : '' }}" name="relation_to_patient"
                                    ...
                                    <div class="col-12 col-md">
                                        <div class="padding-wrap">
                                            <input type="text" class="form-control custom-mainforminput  @if($errors->get('address1')) is-invalid @endif"
                                                name="address1"   value="{{old('address1')}}" id="address1" />
                                    ...
                                    <div class="col-12 col-md">
                                        <div class="padding-wrap">
                                            <input type="text" class="form-control custom-mainforminput  @if($errors->get('address2')) is-invalid @endif"
                                                name="address2"   value="{{old('address2')}}" id="address2" />
                                    ...
                                    <div class="col-12 col-md">
                                        <div class="padding-wrap">
                                            <input type="text" class="form-control custom-mainforminput  @if($errors->get('state')) is-invalid @endif"
                                                name="state"   value="{{old('state')}}" id="state" />
                        ...
                        <div class="form-group row margin-top align-items-end">
                            <div class="col-12 col-md-4">
                                ...
                                <input type="text" class="form-control custom-mainforminput  @if($errors->get('qcard_number')) is-invalid @endif"  value="{{old('qcard_number')}}" name="qcard_number"
                                    id="qcard_number" />
                            </div>
            ...
            <div class="form-section">
                ...
                <div class="form-group row margin-top">
                    ...
                    <div class="col-12 col-md-8">
                        ...
                        <textarea class="form-control custom-mainforminput @if($errors->get('description')) is-invalid @endif" rows="5"   name="description"  id="description">{{old('description')}}</textarea>
                    </div>
                </div>
                <div class="form-group row margin-top">
                    <div class="col-12">
                ...
                <div class="form-group row">
                    <div class="col-12">
                        ...
                        <div class="row no-gutters">
                            <div class="col-12 col-md-2">
                                <div class="padding-wrap">
                                    <input type="text" class="form-control custom-mainforminput @if($errors->get('cc_first_name')) is-invalid @endif" value="{{old('cc_first_name')}}" name="cc_first_name"  id="cc_first_name"/>
                                    <p><small>First name</small></p>
                                </div>
                            </div>
                            <div class="col-12 col-md-2">
                                <div class="padding-wrap">
                                    <input type="text" class="form-control custom-mainforminput @if($errors->get('cc_last_name')) is-invalid @endif" value="{{old('cc_last_name')}}" name="cc_last_name"  id="cc_last_name"/>
                                    <p><small>Last name</small></p>
                                </div>
                            </div>
                            <div class="col-12 col-md-3">
                                <div class="padding-wrap">
                                    <input type="text" class="form-control custom-mainforminput @if($errors->get('cc_number')) is-invalid @endif" value="{{old('cc_number')}}" name="cc_number"  id="cc_number" placeholder="**** **** **** ****" data-inputmask='"mask": "9999 9999 9999 999"' data-mask placeholder="MM / YY" />
                                    <p><small>Credit Card Number</small></p>
                                </div>
                            </div>
                            <div class="col-12 col-md-3">
                                <div class="padding-wrap">
                                    <input type="text" class="form-control custom-mainforminput @if($errors->get('cc_cvc')) is-invalid @endif" maxlength="3" value="{{old('cc_cvc')}}" name="cc_cvc"  id="cc_cvc" placeholder="CVC" maxlength="4" />
                                    <p><small>Security Code</small></p>
                                </div>
                            </div>
                            <div class="col-12 col-md-2">
                                <div class="padding-wrap">
                                    <input type="text" class="form-control custom-mainforminput @if($errors->get('cc_expiration')) is-invalid @endif" value="{{old('cc_expiration')}}" name="cc_expiration"  id="cc_expiration" data-inputmask='"mask": "99 / 99"' data-mask placeholder="MM / YY" />
