...
<body>
    ...
    <!--</div>-->
    <script>
        $(document).ready(function(){$('#errorsModal').modal('show');})
    </script>
    @endif
    ...
    <div class="wrapper d-flex flex-column">
        ...
        ?>
                ...
                <form method="post" action="{{route('InOfficeAppointments.update',$InOfficeAppointmentsDetails->id)}}" class="position-relative">
                    {{csrf_field()}} 
                                ...
                                <div class="form-group row margin-top">
                                    ...
                                    <div class="col-12 col-md-8">
                                        ...
                                        <textarea
                                            ...
                                            id="description">{{old('description')}} @if(isset($InOfficeAppointmentsDetails)) {{$InOfficeAppointmentsDetails->description}}  @endif</textarea>
                                    </div>
                                </div>
                                <div class="form-group row margin-top">
                                    <div class="col-12">
                                    ...
                                    <input type="hidden" id="date-hidden" name="appointment_date" value="{{old('appointment_date')}} @if(isset($InOfficeAppointmentsDetails)) {{$InOfficeAppointmentsDetails->appointment_date}}  @endif">
                                    <input type="hidden" id="appointment_from-hidden" value="{{old('appointment_from')}} @if(isset($InOfficeAppointmentsDetails)) {{$InOfficeAppointmentsDetails->appointment_from}}  @endif" name="appointment_from">
                                    <input type="hidden" id="appointment_to-hidden" value="{{old('appointment_to')}} @if(isset($InOfficeAppointmentsDetails)) {{$InOfficeAppointmentsDetails->appointment_to}}  @endif" name="appointment_to">
                                </div>
                            </div>
                            <div class="form-section">
                                <div class="form-group row mt-4">
                                        ...
                                        <div class="row no-gutters">
                                            <div class="col-12 col-md-4">
                                                <div class="padding-wrap">
                                                    <input type="text"
                                                        class="form-control custom-mainforminput @if($errors->get('first_name')) is-invalid @endif" name="first_name" id="first_name" value="{{old('first_name')}} @if(isset($InOfficeAppointmentsDetails)) {{$InOfficeAppointmentsDetails->appointment_to}}  @endif" />
                                            ...
                                            <div class="col-12 col-md-4">
                                                <div class="padding-wrap">
                                                    <input type="text"
                                                        class="form-control custom-mainforminput @if($errors->get('middle_name')) is-invalid @endif" name="middle_name" id="patient_middle_name" value="{{old('middle_name')}} @if(isset($InOfficeAppointmentsDetails)) {{$InOfficeAppointmentsDetails->middle_name}}  @endif" />
                                            ...
                                            <div class="col-12 col-md-4">
                                                <div class="padding-wrap">
                                                    <input type="text"
                                                        class="form-control custom-mainforminput @if($errors->get('last_name')) is-invalid @endif" name="last_name" id="last_name" value="{{old('last_name')}} @if(isset($InOfficeAppointmentsDetails)) {{$InOfficeAppointmentsDetails->last_name}}  @endif" />
                                    ...
                                    <div class="col-12 col-md-2">
                                        ...
                                        <input type="tel"
                                            class="form-control custom-mainforminput @if($errors->get('telephone')) is-invalid @endif" name="telephone" id="telephone" value="{{old('telephone')}} @if(isset($InOfficeAppointmentsDetails)) {{$InOfficeAppointmentsDetails->telephone}}  @endif" data-inputmask='"mask": "(999) 999-9999"' data-mask />
                                    </div>
                                    <div class="col-12 col-md-2">
                                        <label>Email <span class="required">*</span></label>
                                        <input type="email" class="form-control custom-mainforminput @if($errors->get('email')) is-invalid @endif" value="{{old('email')}} @if(isset($InOfficeAppointmentsDetails)) {{$InOfficeAppointmentsDetails->email}}  @endif" name="email" id="email" />
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group row mt-4">
                                    <div class="col-12 col-md-6">
                                        ...
                                        <div class="row no-gutters">
                                            <div class="col-12 col-md-4">
                                                <div class="padding-wrap">
                                                    <input type="text"
                                                        class="form-control custom-mainforminput @if($errors->get('patient_fname')) is-invalid @endif" name="patient_fname" id="patient_fname" value="{{old('patient_fname')}} @if(isset($InOfficeAppointmentsDetails)) {{$InOfficeAppointmentsDetails->patient_fname}}  @endif" />
                                                    <p><small>First name</small></p>
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-4">
                                                <div class="padding-wrap">
                                                    <input type="text"
                                                        class="form-control custom-mainforminput @if($errors->get('patient_mname')) is-invalid @endif" name="patient_mname" id="patient_mname" value="{{old('patient_mname')}} @if(isset($InOfficeAppointmentsDetails)) {{$InOfficeAppointmentsDetails->patient_mname}}  @endif" />
                                                    <p><small>Middle name</small></p>
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-4">
                                                <div class="padding-wrap">
                                                    <input type="text"
                                                        class="form-control custom-mainforminput @if($errors->get('patient_lname')) is-invalid @endif" name="patient_lname" id="patient_lname" value="{{old('patient_lname')}} @if(isset($InOfficeAppointmentsDetails)) {{$InOfficeAppointmentsDetails->patient_lname}}  @endif" />
                                                    <p><small>Last name</small></p>
                                    ...
                                    <div class="col-12 col-md-2">
                                        <div class="padding-wrap">
                                            ...
                                            <input type="text" value="{{old('dob')}} @if(isset($InOfficeAppointmentsDetails)) {{$InOfficeAppointmentsDetails->dob}}  @endif"
                                    ...
                                    <div class="col-12 col-md-3">
                                        <div class="padding-wrap">
                                            ...
                                            <label class="mt-2"><input type="radio" class="mr-2" name="is_patient_minor" id="is_patient_minor" value="yes" <?php if(old('is_patient_minor') == 'yes'){ echo 'checked';}elseif($InOfficeAppointmentsDetails->is_patient_minor == 'yes'){echo 'checked';}?> >Yes</label>
                                            <label class="mt-2"><input type="radio" class="mr-2"name="is_patient_minor" id="is_patient_minor"value="no" <?php if(old('is_patient_minor') == 'no'){ echo 'checked';}elseif($InOfficeAppointmentsDetails->is_patient_minor == 'no'){echo 'checked';}?>>No</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row margin-top">
                                    <div class="col-12 col-md-10">
                                        ...
                                        <textarea class="form-control custom-mainforminput @if($errors->get('symptoms')) is-invalid @endif" rows="5" name="symptoms" id="symptoms">{{old('symptoms')}} @if(isset($InOfficeAppointmentsDetails)) {{$InOfficeAppointmentsDetails->symptoms}}  @endif</textarea>
                                    </div>
                                </div>
                                <div class="form-group row mt-4">
                                    <div class="col-12 col-md-3">
                                        <label>Responsible Party (If Minor)</label>
                                        <input type="text" class="form-control custom-mainforminput @if($errors->get('patient_responsible_part')) is-invalid @endif" name="patient_responsible_part" id="patient_responsible_part" value="{{old('patient_responsible_part')}} @if(isset($InOfficeAppointmentsDetails)) {{$InOfficeAppointmentsDetails->patient_responsible_part}}  @endif">
                                        <p><small>Enter Full Legal Name
                                            </small></p>
                                    </div>
                                    <div class="col-12 col-md-3">
                                        <label>Full Name of Insurance Subscriber</label>
                                        <input type="text" class="form-control custom-mainforminput @if($errors->get('patient_insurance_subscriber')) is-invalid @endif" name="patient_insurance_subscriber" id="patient_insurance_subscriber" value="{{old('patient_insurance_subscriber')}} @if(isset($InOfficeAppointmentsDetails)) {{$InOfficeAppointmentsDetails->patient_insurance_subscriber}}  @endif">
                                    </div>
                                    <div class="col-12 col-md-2">
                                        ...
                                        <input type="text" class="form-control custom-mainforminput  @if($errors->get('relation_patient')) is-invalid @endif" name="relation_patient" id="relation_patient"
                                            value="{{old('relation_patient')}} @if(isset($InOfficeAppointmentsDetails)) {{$InOfficeAppointmentsDetails->relation_patient}}  @endif">
                                        <p><small>Self, Father, Mother, Son, etc.
                                            </small></p>
                                    </div>
                                    <div class="col-12 col-md-2">
                                        <label>Telephone <span class="required">*</span></label>
                                        <input type="tel" class="form-control custom-mainforminput  @if($errors->get('patient_telephone')) is-invalid @endif" name="patient_telephone" id="patient_telephone" value="{{old('patient_telephone')}} @if(isset($InOfficeAppointmentsDetails)) {{$InOfficeAppointmentsDetails->patient_telephone}}  @endif">
                                    </div>
                                    <div class="col-12 col-md-2">
                                        <label>Email <span class="required">*</span></label>
                                        <input type="email" class="form-control custom-mainforminput  @if($errors->get('patient_email')) is-invalid @endif" name="patient_email" id="patient_email" value="{{old('patient_email')}} @if(isset($InOfficeAppointmentsDetails)) {{$InOfficeAppointmentsDetails->patient_email}}  @endif">
                                    </div>
                                </div>
                                <div class="form-group row mt-4">
                                    <div class="col-12 col-md-3">
                                        ...
                                        <input type="text" class="form-control custom-mainforminput  @if($errors->get('patient_primary_insurance_company')) is-invalid @endif" name="patient_primary_insurance_company" id="patient_primary_insurance_company"
                                            value="{{old('patient_primary_insurance_company')}} @if(isset($InOfficeAppointmentsDetails)) {{$InOfficeAppointmentsDetails->patient_primary_insurance_company}}  @endif">
                                    </div>
                                    <div class="col-12 col-md-3">
                                        ...
                                        <input type="text" class="form-control custom-mainforminput  @if($errors->get('patient_secondary_insurance_company')) is-invalid @endif" name="patient_secondary_insurance_company" id="patient_secondary_insurance_company"
                                            value="{{old('patient_secondary_insurance_company')}} @if(isset($InOfficeAppointmentsDetails)) {{$InOfficeAppointmentsDetails->patient_secondary_insurance_company}}  @endif">
                                    </div>
                                </div>
                            </div>
                            <div class="form-section">
                                        ...
                                        <div class="form-group row mt-4">
                                            <div class="col-12 col-md-2">
                                                <div class="padding-wrap">
                                                    ...
                                                    <label class="mt-2"><input type="checkbox" class="mr-2" id="accept_financial_policy" name="accept_financial_policy"  value="yes" <?php if(old('accept_financial_policy') == 'yes'){ echo 'checked';}elseif($InOfficeAppointmentsDetails->accept_financial_policy){ echo 'checked';}?>>Accept</label>
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-2">
                                                <div class="padding-wrap">
                                                    <label>Date</label>
                                                    <input type="date"
                                                        class="form-control custom-mainforminput todayDatePicker @if($errors->get('fp_date')) is-invalid @endif" value="{{old('fp_date')}}@if(isset($InOfficeAppointmentsDetails)){{$InOfficeAppointmentsDetails->fp_date}}@endif" name="fp_date" id="fp_date" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-section">
                                        ...
                                        <div class="form-group row mt-4">
                                            <div class="col-12 col-md-2">
                                                <div class="padding-wrap">
                                                    <label>Click To Accept <span class="required">*</span></label><br />
                                                    <label class="mt-2"><input type="checkbox" class="mr-2" id="accept_consent_for_treatment" name="accept_consent_for_treatment" value="accept" <?php if(old('accept_consent_for_treatment') == 'yes'){ echo 'checked';}elseif($InOfficeAppointmentsDetails->accept_consent_for_treatment){ echo 'checked';}?>>Accept</label>
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-2">
                                                <div class="padding-wrap">
                                                    <label>Date</label>
                                                    <input type="date" class="form-control custom-mainforminput todayDatePicker @if($errors->get('cft_date')) is-invalid @endif" name="cft_date" id="cft_date" value="{{old('cft_date')}}@if(isset($InOfficeAppointmentsDetails)){{$InOfficeAppointmentsDetails->cft_date}}@endif"  />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group row mt-4">
                                                <div class="col-12">
                                                    <div class="padding-wrap">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12 col-md-3">
                                                                <label class="mt-2"><input type="radio" class="mr-2" id="hear_about_us" name="hear_about_us" value="Google" <?php if(old('hear_about_us') == 'Google'){ echo 'checked';}elseif($InOfficeAppointmentsDetails->hear_about_us == 'Google'){ echo 'checked';}?>>Google</label>
                                                            </div>
                                                            <div class="col-12 col-md-3">
                                                                <label class="mt-2"><input type="radio" class="mr-2" id="hear_about_us" name="hear_about_us" value="Facebook" <?php if(old('hear_about_us') == 'Facebook'){ echo 'checked';}elseif($InOfficeAppointmentsDetails->hear_about_us == 'Facebook'){ echo 'checked';}?>>Facebook</label>
                                                            </div>
                                                            <div class="col-12 col-md-3">
                                                                <label class="mt-2"><input type="radio" class="mr-2" id="hear_about_us" name="hear_about_us" value="Website" <?php if(old('hear_about_us') == 'Website'){ echo 'checked';}elseif($InOfficeAppointmentsDetails->hear_about_us == 'Website'){ echo 'checked';}?>>Website</label>
                                                            </div>
                                                            <div class="col-12 col-md-3">
                                                                <label class="mt-2"><input type="radio" class="mr-2" id="hear_about_us" name="hear_about_us" value="Email" <?php if(old('hear_about_us') == 'Email'){ echo 'checked';}elseif($InOfficeAppointmentsDetails->hear_about_us == 'Email'){ echo 'checked';}?>>Email</label>
                                                            </div>
                                                            <div class="col-12 col-md-3">
                                                                <label class="mt-2"><input type="radio" class="mr-2" id="hear_about_us" name="hear_about_us" value="Friends/Family" <?php if(old('hear_about_us') == 'Friends/Family'){ echo 'checked';}elseif($InOfficeAppointmentsDetails->hear_about_us == 'Friends/Family'){ echo 'checked';}?>>Friends/Family</label>
                                                            </div>
                                                            <div class="col-12 col-md-3">
                                                                <label class="mt-2"><input type="radio" class="mr-2"  id="hear_about_us"  name="hear_about_us" value="Billboard" <?php if(old('hear_about_us') == 'Billboard'){ echo 'checked';}elseif($InOfficeAppointmentsDetails->hear_about_us == 'Billboard'){ echo 'checked';}?>>Billboard</label>
                                                            </div>
                                                            <div class="col-12 col-md-3">
                                                                <label class="mt-2"><input type="radio" class="mr-2"  id="hear_about_us"  name="hear_about_us" value="Radio" <?php if(old('hear_about_us') == 'Radio'){ echo 'checked';}elseif($InOfficeAppointmentsDetails->hear_about_us == 'Radio'){ echo 'checked';}?>>Radio</label>
                                                            </div>
                                                            <div class="col-12 col-md-3">
                                                                <label class="mt-2"><input type="radio" class="mr-2"  id="hear_about_us"  name="hear_about_us" value="Drove By" <?php if(old('hear_about_us') == 'Drove By'){ echo 'checked';}elseif($InOfficeAppointmentsDetails->hear_about_us == 'Drove By'){ echo 'checked';}?>>Drove By</label>
                                                            </div>
                                                            <div class="col-12 col-md-3">
                                                                <label class="mt-2 d-flex align-items-center"><input type="radio" class="mr-2" id="hear_about_us"  name="hear_about_us" value="Other" <?php if(old('Other') == 'yes'){ echo 'checked';}elseif($InOfficeAppointmentsDetails->hear_about_us == 'Other'){ echo 'checked';}?>>
    ...
    <script>
        ...
        if("@if(isset($InOfficeAppointmentsDetails)){{$InOfficeAppointmentsDetails->visit_type}}@endif)" != "")
        { 
            selectElement('visit_type', '@if(isset($InOfficeAppointmentsDetails)){{$InOfficeAppointmentsDetails->visit_type}}@endif');
        }
        else
        {
            selectElement('visit_type', '{{old('visit_type')}}');
        ...
        if("@if(isset($appoint_date_range)){{$appoint_date_range->time_zone}}@endif" != "")
        { 
            
        }
        else
        {
            selectElement('timezonepicker', '{{old('timezonepicker')}}');
        }
        selectElement('timezonepicker', '@if(isset($appoint_date_range)){{$appoint_date_range->time_zone}}@endif');
