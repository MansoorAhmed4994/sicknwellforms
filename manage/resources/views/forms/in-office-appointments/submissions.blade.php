                ...
                <table class="submissions-table table">
                        <tr>
                            ...
                            <th>
                                <div class="d-flex align-items-center">
                                    <i class="fas fa-calendar-alt"></i>
                                    <span>P.PRIMARY INSURANCE COMPANY</span>
                                </div>
                            </th>
                            ...
                            <th>
                                <div class="d-flex align-items-center">
                                    <i class="fas fa-calendar-alt"></i>
                                    <span>P.SECONDARY INSURANCE COMPANY</span>
                                </div>
                            </th>
                        ...
                        <tr> 
                            <td>
                                <div class="d-flex align-items-center">  
                                    <span><a href="{{route('InOfficeAppointments.edit',$row->id)}}">Edit</a></span>
                                </div>
                            </td> 
                            <td>
                                <div class="d-flex align-items-center">  
                                    <span><a href="{{route('InOfficeAppointments.create.zoom.meeting',$row->id)}}">Create Meeting</a></span>
                                </div>
                            </td> 
                            <td>
                                <div class="d-flex align-items-center"> 
                            ...
                            <td>
                                <div class="d-flex align-items-center"> 
                                    <span>{{ $row->patient_responsible_part}}</span>
                                </div>
                            </td>  
                            <td>
                                <div class="d-flex align-items-center"> 
                                    <span>{{ $row->patient_insurance_subscriber}}</span>
                                </div>
                            </td>  
                            <td>
                                <div class="d-flex align-items-center"> 
                                    <span>{{ $row->patient_telephone}}</span>
                                </div>
                            </td> 
                            <td>
                                <div class="d-flex align-items-center"> 
                            ...
                            <td>
                                <div class="d-flex align-items-center"> 
                                    <span>{{ $row->patient_primary_insurance_company}}</span>
                                </div>
                            </td>
                            <td>
                                <div class="d-flex align-items-center"> 
