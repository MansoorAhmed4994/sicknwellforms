            ...
            <div class="scrollbar-fancy h-100">
                <table class="submissions-table table">
                        ...
                        <tr> 
                            <td>
                                <div class="d-flex align-items-center">  
                                    <span><a href="{{route('QcmOccupationAlHealthSafeWorkerProgram.edit',$row->id)}}">Edit</a></span>
                                </div>
                            </td> 
                            <td>
                                <div class="d-flex align-items-center">  
                                    <span><a href="{{route('QcmOccupationAlHealthSafeWorkerProgram.create.zoom.meeting',$row->id)}}">Create Meeting</a></span>
                                </div>
                            </td> 
                            <td>
                                <div class="d-flex align-items-center"> 
