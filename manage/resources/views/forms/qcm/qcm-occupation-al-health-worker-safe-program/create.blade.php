...
<div class="wrapper d-flex flex-column">
    <main class="flex-1 d-flex">
        ...
        <div class="qcm-form">
            ...
            <form method="post" action="{{route('QcmOccupationAlHealthSafeWorkerProgram.create')}}" class="position-relative">
                {{csrf_field()}}
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="row no-gutters">
                                ...
                                <div class="col-12 col-md-4">
                                    ...
                                    <div class="padding-wrap">
                                        <input type="text"
                                               class="form-control custom-mainforminput  @if($errors->get('last_name')) is-invalid @endif" value="{{old('last_name')}}"
                        ...
                        <div class="col-12 col-md-6">
                            <div class="row no-gutters">
                                <div class="col-12 col-md-4">
                                    ...
                                    <div class="padding-wrap">
                                        <input type="text"
                                               class="form-control custom-mainforminput  @if($errors->get('company_name')) is-invalid @endif" value="{{old('company_name')}}"
