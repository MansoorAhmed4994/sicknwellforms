...
<div class="wrapper d-flex flex-column">
    <main class="flex-1 d-flex">
        ...
        <div class="qcm-form">
            ...
            <form method="post" action="{{route('QcmContactUs.create')}}" class="position-relative">
            {{csrf_field()}}
                            ...
                            <div class="row no-gutters">
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="padding-wrap">
                                        <input type="text" class="form-control custom-mainforminput @if($errors->get('first_name')) is-invalid @endif" value="{{old('first_name')}}" name="first_name" id="first_name"/>
                                    </div>
                                </div>
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="row no-gutters">
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="padding-wrap">
                                        <input type="text"
                                               class="form-control custom-mainforminput  @if($errors->get('last_name')) is-invalid @endif" value="{{old('last_name')}}" name="last_name" id="last_name"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="row no-gutters">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="padding-wrap">
                                        <input type="tel"
                                               class="form-control custom-mainforminput  @if($errors->get('phone_number')) is-invalid @endif" value="{{old('phone_number')}}" name="phone_number" id="phone_number" data-inputmask='"mask": "(999) 999-9999"' data-mask />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="row no-gutters">
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="padding-wrap">
                                        <input type="email"
                                               class="form-control custom-mainforminput  @if($errors->get('email')) is-invalid @endif" value="{{old('email')}}" name="email" id="email" />
                                    </div>
                                </div>
