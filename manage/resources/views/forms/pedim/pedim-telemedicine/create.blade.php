                ...
                <div class="custom-wizard">
                    <div class="wizard-sec active ">
                        <div class="top-section">
                            <h2> PEDIM - Telemedicine</h2>
                            <p>Request an appointment.</p>

                        </div>
                        <div class="form-section">
                            <p>Your well being is our priority. Request your appointment below and you will be able to do a Telemedicine  Consultation with a medical provider. You can use your smart telephone, tablet or desktopIf you are using a desktop system, then please verify that your Camera, Speakers and Microphone are in working order. If you are a new patient, please call 352-527-6888..<br /><br />
                                We are currently accepting telemedicine appointments from 8:30 AM to 4:15 PM | Monday thru Friday.
                            </p>
                        </div>
                        <div class="form-section">
                            ...
                            <div class="form-group row margin-top">
                                ...
                                <div class="col-12 col-md-4">
                                    ...
                                    <select class="timezonePicker" id="timezonepicker" name="timezonepicker"  @if(isset($appoint_date_range->time_zone)) disabled @endif>
                                        ...
                                        <option value="America/North_Dakota/Center">America/North_Dakota/Center
                                        </option>
                                        <option value="America/North_Dakota/New_Salem">
                                            America/North_Dakota/New_Salem
                                        </option>
                                        <option value="America/North_Dakota/Beulah">America/North_Dakota/Beulah
                                        </option>
                                        ...
                                        <div class="card-body">
                                            <div class="form-input-wide">
                                                <div class="form-html">
                                                    ...
                                                    <p>WELCOME TO PedIM Healthcare!</p>
                                                    <p>Our staff is committed to providing you with excellence in care, not only in the medical, but also the financial area.
                                                        In order to achieve this goal, we feel it necessary to clarify our payment policy.</p>
                                                    <p>First of all, PedIM is primary care facility.</p>
                                                    <p>As such, some of the billing rules/regulations vary from those to which you may have become accustomed. Several of our insurance carriers have required contracts that have necessitated “global billing”, meaning that any service performed within the facility will be covered by one fee-regardless of the level of service. Others do not, and are billed in the manner to which you are probably familiar. Self-Pay patients are served at a reduced rate for the visit, but are charged “ala carte” for any additional service that the provider feels necessary to supply excellent patient care..<br><br></p>
                                                    ...
                                                    <p>I, <strong><span
                                                        ...
                                                        acknowledge that I have read and understand the above PedIM financial policies.
                                                    </p>
                                                    <p>&nbsp;</p>
                                            ...
                                            <div class="form-input-wide">
                                                <div class="form-html">
                                                    ...
                                                    <p><br>I acknowledge that I have been offered a copy of your
                                                        ...
                                                        time, and that I may contact PedIM Healthcare at any time&nbsp;
                                                        to obtain a current copy of the Notice of Privacy
                                                        Practices.</p>
