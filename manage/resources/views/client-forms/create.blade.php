...
<div class="flex-1">
    <div class="scrollbar-fancy h-100">
        <div class="form-type-1">
            <form action="{{route('create-client-form')}}" method="post" class="create-client-form">
                {{csrf_field()}}
                        ...
                        <div class="wizard-sec active">
                                ...
                                <div class="col-12 col-md-4 col-lg-4">
                                    ...
                                    <select class="form-control custominput @if($errors->get('job_title')) validate-field-red @endif" name="job_title">
                                        ...
                                        <option value="CFO / Treasurer / Controller">CFO / Treasurer /
                                            Controller</option>
                                        <option value="Director / Assistant Director / Department Head">Director /
                                            Assistant Director / Department Head</option>
                            ...
                            <div class="row form-group align-items-center">
                                ...
                                <div class="col-12 col-md-10">
                                    <button class="nextprevbtn float-right next">Next</button>
                                </div>
                            </div>
                        </div>
                        <div class="wizard-sec">
                            <input type="hidden" id="hiddenappointments" name="hiddenappointments">
                                    ...
                                    <div class="interval-item">
                                        ...
                                        <div class="row form-group">
                                            <div class="col-12 col-md-12">
                                                <label class="mb-2">Appointment Days</label>
                                                <select class="form-control custominput appointmentDays" multiple>
                            ...
                            <div class="row-with-heading form-group">
                                <div class="row">
                                    <div class="col-12">
                                        <h4>Lunch Time <small>(Optional)</small></h4>
                                    </div>
                                </div>
                                <div class="row align-items-end">
                                    <div class="col-12 col-md-3">
...
<input class="form-control custominput lunch_time_end timeEntry clear-input" placeholder="Type here" />
                            ...
                            <div class="row-with-heading form-group">
                                <div class="row">
                                    <div class="col-12">
                                        <h4>Limit Start & End Dates <small>(Optional)</small></h4>
                                    </div>
                                </div>
                                <div class="row align-items-end">
                                    <div class="col-12 col-md-3">
                            ...
                            <div class="row form-group align-items-center">
                                <div class="col-12 d-flex align-items-center justify-content-between">
                                    <button class="nextprevbtn btn-cust prev">Back</button>
                            ...
                            <div class="row">
                                <div class="col-12 d-flex align-items-center justify-content-between">
                                    <button class="expand-collapse btn-cust mt-3">Tgl</button>
                                    <button class="cal-btn btn-cust mt-3">Calculate Appointments</button>
                                </div>
                            </div>
                            <div class="row form-group">
                                <div class="col-12">
                                    <table class="table appointmentstable">
                                        <thead>
                                            <tr>
                                                <th scope="col" class="font-weight-bold">Appointment Day</th>
                                                <th scope="col" class="font-weight-bold">Start from</th>
                                                <th scope="col" class="font-weight-bold">End at</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        </tbody>
